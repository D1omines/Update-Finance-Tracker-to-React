...
export default function Footer() {
  return (
    <footer className="h-fit bg-stone-800 px-10 text-white mt-5 flex flex-col items-center gap-4 py-5 xl:flex-row xl:justify-between">
      <div>
      ...
      <div className="flex gap-5">
        <a href="https://t.me/DensVolnov" target="_blank">
          <img className="w-12 xl:w-8" src={telegramIcon} alt="telegram icon" />
        </a>
        <a href="https://wa.me/79032227110" target="_blank">
          <img className="w-12 xl:w-8" src={whatsappIcon} alt="whatsapp icon" />
        </a>
        <a href="https://github.com/D1omines" target="_blank">
          <img className="w-12 xl:w-8" src={githubIcon} alt="github icon" />
        </a>
      </div>
    </footer>
  );
